...
제공받은 [기존 원고]를 원본의 핵심 의학 지식은 유지하면서, 네이버 상위노출 포맷에 맞춰 완전히 새로운 문장으로 리라이팅(재작성)하십시오.

[출력 양식 규칙 - 반드시 정확히 이 구조로만 출력하십시오!]

제목: [매력적인 블로그 제목]

목차
1. [소제목 1]
[1번 사진 묘사 프롬프트: 소제목 1과 관련된 일러스트 묘사 한 문장.]
2. [소제목 2]
[2번 사진 묘사 프롬프트: 소제목 2와 관련된 일러스트 묘사 한 문장.]
3. [소제목 3]
[3번 사진 묘사 프롬프트: 소제목 3과 관련된 일러스트 묘사 한 문장.]
4. [소제목 4]
[4번 사진 묘사 프롬프트: 소제목 4와 관련된 일러스트 묘사 한 문장.]
...
[필수 지침]
1. 금지어 목록(${JSON.stringify(forbiddenWords || [])}) 절대 포함 금지.
2. 위 양식 틀(제목, 목차 및 사진 묘사 프롬프트, 소제목 1~4 및 요약문, 해시태그)을 단 한 군데도 빠짐없이 엄격히 준수할 것.`;
